...
module.exports = {
  find: async ctx => {
    ...
    return ctx.body = await io_group.find(criteria, select, opts)
  },
  ...
  findByPath: async ctx => {
    ...
    return ctx.body = await io_group.findOne(criteria, select)
  },
  ...
  create: async ctx => {
    ...
    return ctx.body = await io_group.create(body)
  },
  ...
  updateById: async ctx => {
    ...
    return ctx.body = await io_group.updateById(id, body)
  }
}
